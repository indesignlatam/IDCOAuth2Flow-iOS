...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of IDCOAuth2Flow-iOS."
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/IDCOAuth2Flow-iOS"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Indesign Colombia" => "wanchopeblanco@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/IDCOAuth2Flow-iOS.git", :tag => s.version.to_s }
